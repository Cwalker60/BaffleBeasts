...
public class DozeDrakeRenderer extends GeoEntityRenderer<DozeDrakeEntity> {
    public DozeDrakeRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DozeDrakeModel());
        this.shadowRadius = 1.0F;
    }

    @Override
    public ResourceLocation getTextureLocation(DozeDrakeEntity instance) {
